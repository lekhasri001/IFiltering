import{j as e}from"./index-DlC1yEB1.js";import{r as i}from"./index-D5jfS-9e.js";import{C as r,a as o,m as ie,b as le,D as G,P as se,G as de,e as ue,W as ce,S as K,c as X,d as pe,f as me,g as $,h as t,T as F,Q as he,U as ge,i as fe,j as we}from"./data-C8fP1DyD.js";import"./index-lf5wH9A6.js";const ye=[40,80,120,200],S=a=>{var D,R,E,T,A;const{enableRtl:f,enableRipple:Y,localDataCount:l,isTextWrapData:C,isDialogInsideGrid:b,isStrictMode:Z,isMultipleChildren:ee,parentContainerHeight:ne="93vh",...n}=a;((E=(R=n.columns)==null?void 0:R[((D=n.columns)==null?void 0:D.length)-1])==null?void 0:E.headerText)==="Command Actions"&&(n.columns[((T=n.columns)==null?void 0:T.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const x=i.useRef(null),w=i.useRef(null),[y,te]=i.useState(!0),[v,ae]=i.useState(!1),re=i.useMemo(()=>C?ie(l):le(l,n.columns),[l,(A=n.columns)==null?void 0:A.length]),d=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>ae(!v),children:[v?"Destroy":"Render"," Data Grid"]}),l&&!C&&e.jsxs("button",{onClick:()=>te(!y),children:[y?"Uniform":"Non Uniform"," Row Height Applied"]}),v&&e.jsx(se,{dir:f?"rtl":"ltr",ripple:Y,locale:n.locale,children:e.jsx(de,{ref:x,dataSource:l?re:[],...n,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,getRowHeight:y?null:oe=>ye[oe.rowIndex%4],children:ee?n.children.props.children:n.children})}),e.jsx("button",{onClick:()=>{console.log(x)},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:w,style:{height:ne,isolation:"isolate"},children:Z?e.jsx(i.StrictMode,{children:b?e.jsx(G,{open:!0,fullScreen:!0,target:w.current,children:d()}):d()}):b?e.jsx(G,{open:!0,fullScreen:!0,target:w.current,children:d()}):d()})};try{S.displayName="LargeDataGridTest",S.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
\`\`\``,name:"loadingIndicatorSettings",required:!1,type:{name:"LoadingIndicatorSettings"}},onGridRenderStart:{defaultValue:null,description:`Fires at the start of grid initialization before data processing.
...
\`\`\``,name:"onFilterDialogAfterOpen",required:!1,type:{name:"(event: FilterDialogAfterOpenEvent) => void"}},onSortStart:{defaultValue:null,description:`Fires when a sorting operation begins on the grid.
...
\`\`\``,name:"onDeleteDialogOpen",required:!1,type:{name:"(eventArgs: DeleteDialogEventArgs) => void"}}}}}catch{}const Re={title:"Grid/VirtualGridBase",component:S,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"}}},s=me(100,!1),ve=[{columns:pe(s.length)}];s.unshift({type:we.Checkbox,width:50,allowFilter:!1});s.push({headerText:"Command Actions",width:200,getCommandItems:()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]});const u={args:{localDataCount:1e5,columns:s,aggregates:ve,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,type:"Excel",enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%"}},c={args:{localDataCount:2e6,columns:s.slice(1,11),editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:2e6},height:"100%"}},p={args:{dataSource:new X({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new ge}),query:new he().addParams("dataCount","100000"),toolbar:["Search"],children:e.jsxs($,{children:[e.jsx(t,{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"}),e.jsx(t,{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"}),e.jsx(t,{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"}),e.jsx(t,{field:"Mail",headerText:"Mail",width:"230"}),e.jsx(t,{field:"Location",headerText:"Location",width:"140"}),e.jsx(t,{field:"Status",headerText:"Status",width:"130"}),e.jsx(t,{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"}),e.jsx(t,{field:"Rating",headerText:"Rating",width:"220"}),e.jsx(t,{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"}),e.jsx(t,{field:"CurrentSalary",headerText:"Current Salary",width:"160",format:"C2"}),e.jsx(t,{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"})]}),selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1,scrollMode:K.Virtual},height:"100%"}},m={args:{dataSource:new X({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new fe}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],selectionSettings:{mode:"Single"},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:K.Virtual},height:"100%"}},h={args:{dataSource:ue,children:e.jsxs($,{children:[e.jsx(t,{headerText:"Employee Image",width:"180",textAlign:F.Center,field:"EmployeeID"}),e.jsx(t,{headerText:"Employee Details",width:"300",textAlign:F.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:a=>{const f=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${a.EmployeeID}.png`;return e.jsxs("tr",{className:"templateRow",children:[e.jsx("td",{className:"photo",children:e.jsx("img",{src:f,alt:a.EmployeeID.toString()})}),e.jsx("td",{className:"details",children:e.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"30%"}}),e.jsx("col",{style:{width:"10%"}})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"First Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.FirstName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Last Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.LastName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Title"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.Title})]})]})]})})]})}}},Se=[{field:"id"},{field:"username",width:150},{field:"age",width:80,type:"number"},{field:"bio",width:400}],g={args:{localDataCount:1e5,isTextWrapData:!0,columns:Se,height:400,textWrapSettings:{enabled:!0,wrapMode:ce.Both}}};var q,k,V;u.parameters={...u.parameters,docs:{...(q=u.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
...
}`,...(V=(k=u.parameters)==null?void 0:k.docs)==null?void 0:V.source}}};var I,M,j;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
...
}`,...(j=(M=c.parameters)==null?void 0:M.docs)==null?void 0:j.source}}};var z,P,W;p.parameters={...p.parameters,docs:{...(z=p.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
...
}`,...(W=(P=p.parameters)==null?void 0:P.docs)==null?void 0:W.source}}};var N,O,U;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(U=(O=m.parameters)==null?void 0:O.docs)==null?void 0:U.source}}};var L,H,B;h.parameters={...h.parameters,docs:{...(L=h.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(B=(H=h.parameters)==null?void 0:H.docs)==null?void 0:B.source}}};var _,Q,J;g.parameters={...g.parameters,docs:{...(_=g.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    localDataCount: 100000,
    isTextWrapData: true,
    columns: muicolumns,
...
}`,...(J=(Q=g.parameters)==null?void 0:Q.docs)==null?void 0:J.source}}};const Ee=["LocalData","OverComeBrowserLimit","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TextWrapSample"];export{u as LocalData,c as OverComeBrowserLimit,h as RowTemplate,g as TextWrapSample,p as UrlAdaptorData,m as WebApiAdaptorData,Ee as __namedExportsOrder,Re as default};
